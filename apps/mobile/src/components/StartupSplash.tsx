...
const styles = StyleSheet.create({
  ...
  logoFrame: { width: "78%", maxWidth: 360, height: 104, position: "relative" },
  logo: { width: "100%", height: 104 },
  wordmarkTopCrop: { position: "absolute", top: 0, left: 0, right: 0, height: 58, overflow: "hidden" },
  wordmarkTop: { width: "100%", height: 104, tintColor: "#2d2d2d" },
});
