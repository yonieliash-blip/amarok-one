...
export function ManagerHomeScreen({ navigation }: HomeProps) {
  ...
  return <FlatList
    ...
    ListHeaderComponent={<View style={styles.header}><Eyebrow>AMAROK ONE</Eyebrow><ScreenTitle>ניהול מהנייד</ScreenTitle><ScreenSubtitle>{user?.organization.name} · גישה מהירה לעבודה בשטח</ScreenSubtitle></View>}
...
const styles = StyleSheet.create({
  page: { flex: 1, backgroundColor: colors.bg }, content: { padding: spacing.md, gap: spacing.md, paddingBottom: spacing.xl }, header: { padding: spacing.md, gap: spacing.sm }, menuCard: { backgroundColor: colors.bgPanel, borderColor: colors.border, borderWidth: 1, borderRadius: radius.lg, padding: spacing.lg, minHeight: 96, justifyContent: "center", gap: spacing.xs }, menuTitle: { color: colors.text, fontSize: 19, fontWeight: "800" }, menuSubtitle: { color: colors.textMuted, fontSize: 14 }, arrow: { position: "absolute", left: spacing.lg, color: colors.primary, fontSize: 34, fontWeight: "400" }, row: { backgroundColor: colors.bgPanel, borderColor: colors.border, borderWidth: 1, borderRadius: radius.md, padding: spacing.md, gap: spacing.sm, marginTop: spacing.md }, selectedRow: { borderColor: colors.primary, backgroundColor: colors.primarySoft }, rowTop: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", gap: spacing.sm }, rowNumber: { color: colors.primary, fontSize: 13, fontWeight: "800" }, rowTitle: { color: colors.text, fontSize: 17, fontWeight: "800" }, rowMeta: { color: colors.textMuted, fontSize: 14, lineHeight: 20 }, detailTitle: { color: colors.text, fontSize: 21, fontWeight: "800" }, detailText: { color: colors.textMuted, fontSize: 15, lineHeight: 22 }, sectionTitle: { color: colors.text, fontSize: 19, fontWeight: "800", marginTop: spacing.md }, chips: { gap: spacing.sm }, loader: { marginTop: spacing.xl }, empty: { color: colors.textMuted, textAlign: "center", marginTop: spacing.xl }, error: { color: colors.error, marginTop: spacing.md, lineHeight: 20 }, fieldLabel: { color: colors.text, fontSize: 15, fontWeight: "800", marginTop: spacing.md }, input: { minHeight: 50, backgroundColor: colors.bgPanel, borderColor: colors.border, borderWidth: 1, borderRadius: radius.md, paddingHorizontal: spacing.md, color: colors.text, fontSize: 16, textAlign: "right" }, textArea: { minHeight: 100, textAlignVertical: "top", paddingTop: spacing.md }, priorityRow: { flexDirection: "row", flexWrap: "wrap", gap: spacing.sm }, choice: { borderWidth: 1, borderColor: colors.border, backgroundColor: colors.bgPanel, paddingHorizontal: spacing.md, paddingVertical: spacing.sm, borderRadius: radius.pill }, choiceSelected: { borderColor: colors.primary, backgroundColor: colors.primarySoft }, choiceText: { color: colors.text, fontWeight: "700" }, footerBlock: { gap: spacing.sm, paddingTop: spacing.md },
});
