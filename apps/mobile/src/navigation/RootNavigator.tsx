          ...
          isManager ? (
            <>
              ...
              <Stack.Screen
                ...
                options={({ route }) => ({
                  title: route.params.kind === "vehicle" ? "חלפים בניידות" : "מחסן חלפים",
                })}
              />
              <Stack.Screen
                name="WorkReport"
                component={WorkReportScreen}
                options={{ title: "דוח עבודה" }}
              />
            </>
          ) : (
            <>
...
const styles = StyleSheet.create({
  ...
  internalHeaderTop: { height: 62, alignItems: "center", justifyContent: "center" },
  headerWordmark: { width: 240, height: 58 },
  internalHeaderTitle: {
    color: colors.text,
